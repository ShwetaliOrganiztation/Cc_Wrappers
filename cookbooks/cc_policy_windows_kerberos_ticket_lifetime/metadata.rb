...
# =================================================================
name             'cc_policy_windows_kerberos_ticket_lifetime'
version          '1.0.7'
...
depends           'cobalt_ohai'
depends          'policy_windows_kerberos_ticket_lifetime' ,'= 0.2.14'

attribute        'cc_policy_windows_kerberos_ticket_lifetime/policy_map',

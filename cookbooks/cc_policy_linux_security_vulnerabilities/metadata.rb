...
# =================================================================
name             'cc_policy_linux_security_vulnerabilities'
version          '1.0.2'
...
depends           'cobalt_ohai'
depends          'policy_linux_security_vulnerabilities' ,'= 0.0.16'

attribute        'cc_policy_linux_security_vulnerabilities/policy_map',

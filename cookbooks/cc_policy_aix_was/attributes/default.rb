...
default['cc_policy_aix_was']['policy_map'] = {"components" => [
                              {
                               identified_by: 'value',
                               id: 'os:aix',
                               "enforced_by" => [{ 
                                                policy: 'policy_aix_was',
                                                enabled: false}]
                              }
                             ]
                          }

default['cc_policy_aix_was']['ui_metadata']['policy_aix_was'] = {
  policy:"policy_aix_was",
  display_name:"policy_aix_was",
...
default['cc_policy_aix_was'] ['override_metadata'] ['policy_aix_was'] = {
'deviations' => [
  {

...
# =================================================================
name             'cc_policy_linux_secure_internal_services'
version          '1.0.1'
...
depends           'cobalt_ohai'
depends          'policy_linux_secure_internal_services' ,'1.0.5'

attribute        'cc_policy_linux_secure_internal_services/policy_map',

default['cc_policy_linux_db2']['policy_map'] = {"components" => [
                              {
                               identified_by: 'value',
                               id: 'os:linux',
                               "enforced_by" => [{ 
                                                policy: 'policy_linux_db2',
                                                enabled: false}]
                              }               
...
default['cc_policy_linux_db2'] ['ui_metadata'] ['policy_linux_db2'] = {
                            policy: 'policy_linux_db2',
                            display_name: 'policy_linux_db2',
              ...
              'attributes' => [{
                ...
                key:"enforce_db2_instance_owners_umask_setting",
                type:"boolean",
                display_name:"enforce_db2_instance_owners_umask_setting",
                display_type:"single_select",
                validator:"^(?i)(true|false)$",
                units:"",
                options:"[{\"key\": \"true\", \"value\": \"true\"}, {\"key\": \"false\", \"value\": \"false\"}]",
                hint:"Switch to enable/disable policy to set db2 instance owners umask value.",
                default:"true"
              },{
                key:"enforce_fenced_user_group_membership",
                type:"boolean",
                display_name:"enforce_fenced_user_group_membership",
                display_type:"single_select",
                validator:"^(?i)(true|false)$",
                units:"",
                options:"[{\"key\": \"true\", \"value\": \"true\"}, {\"key\": \"false\", \"value\": \"false\"}]",
                hint:"Switch to enable/disable policy to for fenced user check.",
                default:"true"
              },{
              ...
              key:"database_audit_events_scope",
                ...
                key:"profile_files",
                type:"CSV",
                display_name:"profile_files",
                display_type:"string_array",
                validator:"",
                units:"",
                options:"",
                hint:"Set umask in below profile files for db2 instance owners, if they exists."
              },{
                key:"instance_owner_umask_value",
                type:"string",
                display_name:"instance_owner_umask_value",
                display_type:"text_box",
                validator:"^[0-7]{0,4}$",
                units:"",
                options:"",
                hint:"Provide umask value for db2 instance owners."
              }
	],
                            validator:'',
                            units:'',
...
default['cc_policy_linux_db2'] ['override_metadata'] ['policy_linux_db2'] = {
'deviations' => [
  {
  ...
  {
    'patterns' => ["change umask from (.*) to (.*)"],
    override_attribute: "instance_owner_umask_value",
    attribute_type: "String",
    override_action: "replace",
    override_value: '$1'
  },
  {
    'patterns' => ["Warn: fenced user (.*) is a member of privileged group (.*) for instance (.*) and it is the users primary group. Change primary group for user (.*)", "remove fenced user (.*) from privileged group (.*) for instance (.*)"],
    override_attribute: "whitelist_fenced_users",

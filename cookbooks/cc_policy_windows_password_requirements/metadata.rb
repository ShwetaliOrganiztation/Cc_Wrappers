...
# =================================================================
name             'cc_policy_windows_password_requirements'
version          '1.0.7'
...
depends           'cobalt_ohai'
depends          'policy_windows_password_requirements' ,'= 0.1.20'

attribute        'cc_policy_windows_password_requirements/policy_map',

...
# cc_policies_windows/default.rb
# Bob Filepp


# NOTE: We circumvent the issue that currently "indentified_by" doesn't include complex #conditions, like (mysql:installed && os:linux)by adding layers to the hierarchy of wrappers
...
puts "wrapper windows completed"
